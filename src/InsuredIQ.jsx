...
export default function InsuredIQ() {
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", background: C.canvas, color: C.ink, fontFamily: FONT, WebkitFontSmoothing: "antialiased" }}>
      {/* ---------- left rail ---------- */}
      <aside style={{ width: 298, flexShrink: 0, height: "100vh", position: "sticky", top: 0, background: C.rail, borderRight: `1px solid rgba(28,28,26,0.10)`, display: "flex", flexDirection: "column" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 13, padding: "22px 20px", borderBottom: `1px solid rgba(28,28,26,0.08)` }}>
          <div style={{ width: 42, height: 42, borderRadius: 11, background: C.brand, display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", fontWeight: 700, fontSize: 17, letterSpacing: -0.5, flexShrink: 0 }}>IQ</div>
        ...
        <div style={{ padding: "16px 18px", borderBottom: `1px solid rgba(28,28,26,0.08)` }}>
          ...
          <div style={{ position: "relative" }}>
            <input className="iq-input" value={query}
              ...
              style={{ width: "100%", height: 38, border: "1px solid rgba(28,28,26,0.18)", borderRadius: 9, padding: "0 12px", fontSize: 13.5, fontFamily: FONT, color: C.ink, background: "#fff", outline: "none" }} />
            {showSuggest && (
